...
const { getUsers, uploadUserImage, resizeImage, createUser, getUserById, updateUser, deleteUser, getLoggedUserAccount, updateLoggedUserPassword, updateLoggedUserData, deleteLoggedUserAccount } = require('../controllers/userController');
const { createUserValidator, getUserValidator, updateUserValidator, deleteUserValidator, changeAccountPasswordValidator, updateLoggedUserDataValidator } = require('../validators/userValidator');
